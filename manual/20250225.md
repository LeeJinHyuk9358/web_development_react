...
많이 사용되었으나 현재는 이용률이 감소했고, 공식 문서에서도 추천하지 않습니다.
...
- ES6 클래스 이용은 현재 공식적으로 권자오디지 않는 중입니다.
...
* vite가 만든 App 컴포넌트에는 구문 긑에 ;이 없습니다. JS 상에서의 세미콜론은 선택사항이긴 한데, 저희는 항상 찍어주는 연습을 하도록 하겠습니다.